  ...
  return (
    <main className="min-h-screen bg-white text-slate-950">
      ...
      <section className="relative min-h-[85vh] overflow-hidden bg-black">
        ...
        <div className="relative z-10 mx-auto flex min-h-[85vh] max-w-7xl flex-col justify-center px-6 py-32 sm:px-10 lg:px-16">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 max-w-2xl text-base leading-7 text-white/60 sm:text-lg sm:leading-8">
              A seasoned civil engineer and construction leader, A. Subash
              brings deep expertise in infrastructure development, project
              execution, and quality-driven construction management to every
              venture under the RACTYSH Group.
            </p>
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-20">
            ...
            <div className="relative">
              <div className="sticky top-32 overflow-hidden rounded-xl border border-slate-200 bg-slate-50 p-8 sm:p-10">
                <div className="mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-[#C4A87C]/10">
                  <span className="text-3xl font-bold text-[#C4A87C]">AS</span>
                </div>
                <h3 className="text-xl font-bold text-slate-950">A. Subash</h3>
